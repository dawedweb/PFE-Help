                    ...
                    @foreach ($teacher as $teacher)
                     ...
                     >
                         <img
                             ...
                             src="/imagesteacher/{{$teacher->image}} "
                             alt=""
                         />
 
                         <h3 class="text-2xl mb-2">{{$teacher->firstname}} {{$teacher->lastname}}</h3>
                         <div class="text-xl font-bold mb-4">spéciatlite:{{$teacher->spéciatité}}</div>

                         <div class="text-xl font-bold mb-4">expérience:{{$teacher->expérience}}</div>
                         <div class="text-xl font-bold mb-4">niveau d'etude :{{$teacher->niveaux_etudes}}</div>
                         <ul class="flex">
                             <li
                         ...
                         <div class="text-lg my-4">
                             <i class="fa-solid fa-location-dot"></i>adresse: {{$teacher->adress}}
                         </div>
                       
                         <div class="border border-gray-200 w-full mb-6"></div>
                         <div>
                             <h3 class="text-3xl font-bold mb-4">
                                  Description de {{$teacher->firstname}} {{$teacher->lastname}}
                             </h3>
                             <div class="text-lg space-y-6">
                                 ...
                                 Contacter avec numero telephone de  {{$teacher->firstname}} {{$teacher->lastname}} : {{$teacher->phone}}</a
                             >
                                 <a
                                     href="{{$teacher->email}}"
                                     class="block bg-black text-white py-2 rounded-xl hover:opacity-80"
                                     ><i class="fa-solid fa-envelope"></i>
                                     Contacter avec email {{$teacher->email}}</a
                                 >
 
                                 <a
                                     href="{{$teacher->lien_compte_facebook}}"
                                     target="_blank"
                                     class="block bg-black text-white py-2 rounded-xl hover:opacity-80"
                                     ><i class="fa-brands fa-facebook-f"></i> Visit
                                     {{$teacher->firstname}} {{$teacher->lastname}} facebook</a
                                 >

                                 <a
                                 href="{{$teacher->lien_compte_instagram}}"
                                 target="_blank"
                                 class="block bg-black text-white py-2 rounded-xl hover:opacity-80"
                                 ><i class="fa-brands fa-instagram"></i> Visit
                                 {{$teacher->firstname}} {{$teacher->lastname}} instagram</a
                             >

                             <a
                                 href="{{$teacher->lien_compte_linkedin}}"
                                 target="_blank"
                                 class="block bg-black text-white py-2 rounded-xl hover:opacity-80"
                                 ><i class="fa-brands fa-linkedin"></i> Visit
                                 {{$teacher->firstname}} {{$teacher->lastname}} linkedin</a
                             >
                             </div>
                         </div>
                     </div>
