              ...
              />
                     <div>
                         ...
                         <div class="text-lg mt-4">
                             <i class="fa-solid fa-location-dot"></i>  {{$teacher->adress}} 
                         </div>
                         <br>
                         


                         <a href="{{url('info_teacher',$teacher->id )}} "> 
                          <input type="button" class="btn btn-primary" value="consulter profile ">
                          </a>
                          <a href="{{url('conceille',$teacher->id )}} "> 
                            <input type="button" class="btn btn-secondary" value="consulter video de {{$teacher->firstname}} {{$teacher->lastname}}  ">
                            </a>
