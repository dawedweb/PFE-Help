      ...
      <div class="row">
        ...
        <div class="col-lg-6">
          <div class="contact-us-content">
            ...
            <form id="contact-form" action="{{url('/modif_video', $vid->id )}}" method="post" enctype="multipart/form-data">
                ...
                <div class="col-lg-12">
                  ...
                  <fieldset>
                    <div style="color: #000000">
                        categorie de la video :
                    </div>
                    <input type="text" name="catname" placeholder="first name" required="" value="   {{$vid->category_name}}">
                    </fieldset>
              </div>
              <div class="col-lg-12">
                ...
                <fieldset>
                    ...
                    <input type="text" name="vidname" placeholder="first name" required="" value=" {{$vid->video_name}}">
                  </fieldset>
            </div>
                  ...
                  <fieldset>
                    ...
                    <div class="form-group row">
                      <label for="video" class="col-sm-3 col-form-label">Upload new Video</label>
...
<div>
<button type="submit" id="form-submit" class="btn btn-primary" href="{{url('/modif')}}">modifier</button>
</div>
@endforeach --}} 
